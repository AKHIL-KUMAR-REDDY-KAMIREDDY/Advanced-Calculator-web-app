...
function calculate() {
  ...
  if(shape == "cone") {
     ...
     if(radius==null || radius=="" || radius<0 || isNaN(radius) || height==null || height=="" || height<0 || isNaN(height)){
      alert("Enter Valid Data");
      return false;
    }
  ...
  if(shape == "ellipsoid") {
    ...
    if(axisa==null || axisa=="" || axisa<0 || isNaN(axisa) || axisb==null || axisb=="" || axisb<0 || isNaN(axisb) || axisc==null || axisc=="" || axisc<0 || isNaN(axisc)){
      alert("Enter Valid Data");
      return false;
    }
