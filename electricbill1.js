...
function EBC(){
    ...
    if(units=="" || units==null || load=="" || load==null || months=="" || months==null || units<0 || load<0 || months<0 || isNaN(units) || isNaN(load) || isNaN(months)){
    ...
    if(selectedvalue=="HOUSE"){
        ...
        document.getElementById('result1').innerHTML="<br><center>Your Total Bill is Rs."+final_result.toFixed(2);
