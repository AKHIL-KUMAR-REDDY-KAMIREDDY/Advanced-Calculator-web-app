...
function Area(){
    ...
    if(shape == "rectangle1"){
        ...
        if(length==null || length=="" || width==null || width=="" || length<0 || width<0 || isNaN(width) || isNaN(length)){
    ...
    if(edge1==null || edge1=="" || edge1<0 || isNaN(edge1) || edge2==null || edge2=="" || edge2<0 || isNaN(edge2) || edge3==null || edge3=="" || edge3<0 || isNaN(edge3)){
        alert("Enter Valid Data");
        return false;
      }
    ...
    if(base1==null || base1=="" || base1<0 || isNaN(base1) || base2==null || base2=="" || base2<0 || isNaN(base2) || height==null || height=="" || height<0 || isNaN(height)){
        alert("Enter Valid Data");
        return false;
      }
    ...
    if(radius==null || radius=="" || radius<0 || isNaN(radius) || degrees==null || degrees=="" || degrees<0 || isNaN(degrees)){
        alert("Enter Valid Data");
        return false;
      }
    ...
    if(major==null || major=="" || major<0 || isNaN(major) || minor==null || minor=="" || minor<0 || isNaN(minor)){
        alert("Enter Valid Data");
        return false;
      }
    ...
    if(shape == "parallelogram1"){
        ...
        if(base==null || base=="" || base<0 || isNaN(base) || height==null || height=="" || height<0 || isNaN(height)){
            alert("Enter Valid Data");
            return false;
          }
